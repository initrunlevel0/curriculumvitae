...
\email{initrunlevel0@gmail.com}

\homepage{wirama.web.id}
\homepage{github.com/initrunlevel0}
...
\end{itemize}
Some of our portfolios can be seen on \url{http://wirama.web.id/my-portofolio/}
} 

\cventry{2015-now}{Sistem Kenaikan Pangkat Pegawai}{Dinas Pendidikan}{Kota Surabaya}{}{With a small team consisting two programmers, I have build an employee rank management system which will be used within state-owned elementary and high schools in whole Surabaya City. Using my own idea to reduce the traffic and processing on the server-side, we managed to use Single-Page Javascript Application pattern using Angular.js for its interface.  \newline{}\newline{}
Skills Developed:
\begin{itemize}
    \item Laravel Framework
    \item Single-Page Javascript Application
    \item Advanced Angular.js
\end{itemize}
} 
